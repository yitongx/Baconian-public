...
class ContinuousMLPGlobalDynamicsModel(GlobalDynamicsModel, DifferentiableDynamics, PlaceholderInput,
    ...
    def __init__(self, env_spec: EnvSpec,
        ...
        with tf.variable_scope(name_scope):
            ...
            action_input = tf.placeholder(shape=[None, env_spec.flat_action_dim], dtype=tf.float32, name='action_ph')
...
class MBMPC_MLPDynamics(ContinuousMLPGlobalDynamicsModel):
    def __init__(self, env_spec: EnvSpec,
                 name_scope: str,
                 name: str,
                 mlp_config: list,
                 ...
                 output_delta_state_scaler: DataScaler = None,
                 init_state=None):
        super().__init__(env_spec, name_scope, name, mlp_config, learning_rate, \
                         state_input_scaler, action_input_scaler, output_delta_state_scaler, init_state)
        # For mb_test
        tf.add_to_collection('delta_obs', self.mlp_net.output)