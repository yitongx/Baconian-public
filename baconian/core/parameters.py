...
class Parameters(object):
    ...
    def copy_from(self, source_parameter):
        ...
        self._update_dict(source_dict=source_parameter._parameters, target_dict=self._parameters)
    ...
    def _update_dict(self, source_dict: dict, target_dict: dict):   # update target according to source
